...
class YOLO(object):
    classes_DIR = os.path.dirname(os.path.abspath(sys.argv[0]))
    _defaults = {
        #--------------------------------------------------------------------------#
    ...
    def __init__(self, **kwargs):
        ...
        #---------------------------------------------------#
        classes_DIR = os.path.dirname(os.path.abspath(sys.argv[0]))
        self.class_names, self.num_classes = get_classes(os.path.join(classes_DIR, 'cls_classes.txt'))
    ...
    def generate(self):
        classes_DIR = os.path.dirname(os.path.abspath(sys.argv[0]))
        model_path = os.path.expanduser(os.path.join(classes_DIR, 'best_epoch_weights.h5'))
        assert model_path.endswith('.h5'), 'Keras model or weights must be a .h5 file.'
        
        self.model = Yolov6([None, None, 3], num_classes = self.num_classes, phi = self.phi)
    ...
    def detect_heatmap(self, image, heatmap_save_path):
        ...
        plt.margins(0, 0)
        directory_path = os.path.dirname(heatmap_save_path)
